    ...
    <div className="grid grid-cols-3 gap-4 w-full h-auto pt-64 lg:flex lg:flex-col lg:pt-32">
      {characteristics.map((item) => {
        ...
        return (
          <section
            key={item.title}
            className="flex flex-col gap-4 w-full h-auto bg-neutral-200 bg-opacity-40 border border-neutral-300 rounded-lg p-8 shadow-sm dark:bg-neutral-800 dark:border-neutral-600"
          >
