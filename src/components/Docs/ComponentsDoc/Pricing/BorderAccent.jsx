...
const BorderAccent = () => {
    ...
    const borderAccentPricing = `<div className="flex w-full justify-center p-4 pt-6 gap-4 bg-neutral-200 dark:bg-neutral-900">
    ...
    <article className="flex flex-col relative gap-6 items-center justify-start w-64 h-auto py-6 bg-white rounded-lg ring-2 ring-blue-500 shadow-md dark:bg-neutral-800">
        <span className='flex absolute -top-3.5 ring-2 ring-blue-500 items-center font-medium h-fit w-fit text-xs px-2.5 py-1 gap-1 bg-blue-100 text-blue-900 rounded-lg cursor-default dark:bg-blue-900 dark:text-blue-300'><svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' viewBox='0 0 24 24'><path fill='currentColor' d='M12.79 21L3 11.21v2c0 .53.21 1.04.59 1.41l7.79 7.79c.78.78 2.05.78 2.83 0l6.21-6.21c.78-.78.78-2.05 0-2.83L12.79 21z' /><path fill='currentColor' d='M11.38 17.41c.78.78 2.05.78 2.83 0l6.21-6.21c.78-.78.78-2.05 0-2.83L12.63.58A2.04 2.04 0 0 0 11.21 0H5C3.9 0 3 .9 3 2v6.21c0 .53.21 1.04.59 1.41l7.79 7.79zM7.25 3a1.25 1.25 0 1 1 0 2.5a1.25 1.25 0 0 1 0-2.5z' /></svg>SAVE $10</span>
        <div className="flex flex-col w-full items-center gap-2 pb-6 border-b-[1px] border-neutral-300 dark:border-neutral-700">
    ...
    return (
        <article>
            <div className='pb-4'>
                ...
                <p className='dark:text-neutral-300'>Use this variant with a border accent to attract the user's attention and make them buy a more expensive subscription.</p>
            </div>
            <div className='flex gap-2 pb-2 select-none lg:flex-col'>
                ...
                <EditInGithub url={'https://github.com/juanigarciadev/BlossomUI/blob/main/src/components/UI/Pricing/Pricing.jsx'} />
            </div>
            <div className='flex flex-col'>
                {showCode ?
                    <div>
                        ...
                        <CodeBlock name={'Border accent'} code={borderAccentPricing} language={'javascript'} />
                    </div>
                    :
                    <section className='flex flex-wrap rounded-lg gap-1 p-4 bg-white border border-neutral-200 w-full dark:bg-[#222222] dark:border-neutral-700'>
                        <BorderAccentPricing />
