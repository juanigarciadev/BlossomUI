...
import { DefaultSkeleton, ImageSkeleton } from '../../../UI/Skeleton/Skeleton'

const ImageSkeletonDoc = () => {

    const [showCode, setShowCode] = useState(false)

    const defaultSkeleton = `<div className='inline-flex gap-1'>
...
export default ImageSkeletonDoc