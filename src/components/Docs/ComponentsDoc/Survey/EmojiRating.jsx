    ...
    return (
        <article>
            ...
            <div className='flex gap-2 pb-2 select-none lg:flex-col'>
                ...
                <EditInGithub url={'https://github.com/juanigarciadev/BlossomUI/blob/main/src/components/UI/Survey/Survey.jsx'} />
            </div>
            <div className='flex flex-col'>
                {showCode ?
                    <div>
                        ...
                        <CodeBlock name={"Emoji rating"} code={emojiRating} language={"javascript"} />
                    </div>
                    :
                    <section className='flex flex-wrap rounded-lg gap-1 p-4 pt-6 bg-white border border-neutral-200 w-full dark:bg-[#222222] dark:border-neutral-700'>
                        <EmojiRatingSurvey />
