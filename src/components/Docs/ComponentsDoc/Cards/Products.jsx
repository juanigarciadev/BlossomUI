...
const Products = () => {
  ...
  const productCard = `<article className="relative flex flex-col gap-4 border bg-neutral-100 w-64 h-fit rounded-lg p-4 shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
    <div>
      <img
        src="https://res.cloudinary.com/diruiumfk/image/upload/v1708208011/nike-logo_jqzbn0.svg"
        alt=""
        className="absolute w-12 h-12 dark:invert"
      />
    </div>
    <div className="absolute right-4">
      ...
      >
        <path
          className="cursor-pointer fill-[#a3a3a3] hover:fill-red-600 dark:fill-[#262626] dark:hover:fill-red-600"
          fill="currentColor"
    ...
    <div>
      <img
        src="https://res.cloudinary.com/diruiumfk/image/upload/v1701482959/jordan-dior_lp6sqo.webp"
        alt="Air Jordan 1 Dior"
      />
    </div>
    <div className="flex flex-col justify-between flex-grow">
      <section className="flex flex-col gap-4">
        <section className="flex flex-col">
          ...
          <span className="text-sm text-neutral-500">Sneakers</span>
        </section>
        <section>
          <section className="flex flex-col gap-1">
            <span className="flex items-center font-medium h-fit w-fit text-xs px-2.5 py-1 gap-1 bg-blue-100 text-blue-900 rounded-lg cursor-default dark:bg-blue-900 dark:text-blue-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="14"
                height="14"
            ...
            <div className="inline-flex gap-1 items-end">
              ...
              <span className="text-[12px] mb-[4px] line-through text-neutral-500">
                $650.00
              </span>
            </div>
          </section>
      ...
      <section className="pt-6">
        <button className="flex justify-center items-center text-center border border-neutral-300 bg-transparent w-full h-fit text-sm gap-2 px-4 py-[11px] rounded-lg cursor-pointer font-medium select-none hover:bg-neutral-200 dark:text-white dark:hover:bg-neutral-800">
          Add to cart
        </button>
      </section>
    </div>
  ...
  return (
    <article>
      ...
      <div className="flex gap-2 pb-2 select-none lg:flex-col">
        ...
        <EditInGithub
          url={
            "https://github.com/juanigarciadev/BlossomUI/blob/main/src/components/UI/Card/Card.jsx"
          }
        />
      </div>
