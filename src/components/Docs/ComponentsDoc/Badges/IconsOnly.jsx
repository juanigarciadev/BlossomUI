...
import { ArrowDownBadge, ArrowUpBadge, DiscountBadge, TimeBadge } from '../../../UI/Badges/Normal/IconsOnly'

const BadgesWithIconsOnly = () => {

    const [showCode, setShowCode] = useState(false)

    const badgesWithIconsOnly = `<span className='flex items-center font-medium h-fit w-fit text-xs px-2 py-2 gap-1 bg-blue-100 text-blue-900 rounded-full cursor-default dark:bg-blue-900 dark:text-blue-300'><svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' viewBox='0 0 24 24'><path fill='currentColor' d='M12.79 21L3 11.21v2c0 .53.21 1.04.59 1.41l7.79 7.79c.78.78 2.05.78 2.83 0l6.21-6.21c.78-.78.78-2.05 0-2.83L12.79 21z' /><path fill='currentColor' d='M11.38 17.41c.78.78 2.05.78 2.83 0l6.21-6.21c.78-.78.78-2.05 0-2.83L12.63.58A2.04 2.04 0 0 0 11.21 0H5C3.9 0 3 .9 3 2v6.21c0 .53.21 1.04.59 1.41l7.79 7.79zM7.25 3a1.25 1.25 0 1 1 0 2.5a1.25 1.25 0 0 1 0-2.5z' /></svg></span>\n<span className='flex items-center font-medium h-fit w-fit text-xs px-2 py-2 gap-1 bg-neutral-100 text-neutral-900 rounded-full cursor-default dark:bg-neutral-700 dark:text-neutral-300'><svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' viewBox='0 0 24 24'><path fill='currentColor' d='M12 2A10 10 0 0 0 2 12a10 10 0 0 0 10 10a10 10 0 0 0 10-10A10 10 0 0 0 12 2m4.2 14.2L11 13V7h1.5v5.2l4.5 2.7l-.8 1.3Z' /></svg></span>\n<span className='flex items-center font-medium h-fit w-fit text-xs px-2 py-2 gap-1 bg-green-100 text-green-900 rounded-full cursor-default dark:bg-green-900 dark:text-green-300'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 24 24'><path fill='currentColor' d='M11 8.414V18h2V8.414l4.293 4.293l1.414-1.414L12 4.586l-6.707 6.707l1.414 1.414z' /></svg></span>\n<span className='flex items-center font-medium h-fit w-fit text-xs px-2 py-2 gap-1 bg-red-100 text-red-900 rounded-full cursor-default dark:bg-red-900 dark:text-red-300'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 24 24'><path fill='currentColor' d='m18.707 12.707l-1.414-1.414L13 15.586V6h-2v9.586l-4.293-4.293l-1.414 1.414L12 19.414z' /></svg></span>`

    return (
        <article>
            <div className='pb-4'>
                <h3 className='text-lg font-medium'>Icons only</h3>
                <p className='dark:text-neutral-300'>Use this variant if you only want to show icons.</p>
            </div>
            <div className='flex pb-2 gap-2 select-none lg:flex-col'>
                ...
                <EditInGithub url={'https://github.com/juanigarciadev/BlossomUI/blob/main/src/components/UI/Badges/Normal/IconsOnly.jsx'} />
            </div>
            <div className='flex flex-col'>
                {showCode ?
                    <div>
                        ...
                        <CodeBlock name={"With icons only"} code={badgesWithIconsOnly} language={"javascript"} />
                    </div>
                    :
                    <section className='flex flex-wrap rounded-lg gap-1 p-4 bg-white border border-neutral-200 w-full dark:bg-[#222222] dark:border-neutral-700'>
                        <DiscountBadge />
...
export default BadgesWithIconsOnly