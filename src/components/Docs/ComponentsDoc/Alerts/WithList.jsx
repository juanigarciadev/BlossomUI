...
import { DefaultAlertWithList, DefaultErrorAlertWithList, DefaultSuccessfulAlertWithList, DefaultWarningAlertWithList } from '../../../UI/Alerts/Default/WithList'
    ...
    return (
        <article>
            ...
            <div className='flex gap-2 pb-2 select-none lg:flex-col'>
                ...
                <EditInGithub url={'https://github.com/juanigarciadev/BlossomUI/blob/main/src/components/UI/Alerts/Default/WithList.jsx'} />
            </div>
            <div className='flex flex-col'>
                {showCode ?
                    <div>
                        ...
                        <CodeBlock name={"With list"} code={defaultButtonsWithList} language={"jsx"} />
                    </div>
                    :
                    <section className='flex flex-wrap rounded-lg gap-1 p-4 bg-white border border-neutral-200 w-full dark:bg-[#222222] dark:border-neutral-700'>
                        <DefaultAlertWithList />
