...
import { BorderAccentAlert, BorderAccentErrorAlert, BorderAccentSuccessfulAlert, BorderAccentWarningAlert } from '../../../UI/Alerts/Default/BorderAccent'
    ...
    return (
        <article>
            ...
            <div className='flex gap-2 pb-2 select-none lg:flex-col'>
                ...
                <EditInGithub url={'https://github.com/juanigarciadev/BlossomUI/blob/main/src/components/UI/Alerts/Default/BorderAccent.jsx'} />
            </div>
