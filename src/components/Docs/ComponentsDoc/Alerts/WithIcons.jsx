...
import { DefaultAlertWithIcon, DefaultErrorAlertWithIcon, DefaultSuccessfulAlertWithIcon, DefaultWarningAlertWithIcon } from '../../../UI/Alerts/WithIcons'
...
const AlertsWithIcons = () => {
    ...
    const githubUrl = 'https://github.com/juanigarciadev/BlossomUI/blob/main/src/components/UI/Alerts/WithIcons.jsx'

    return (
        <article>
            <CompVersionTitle title={"With icons"} paragraph={"Use default alerts with multiple colors to correct user inputs."}/>
            ...
            <div className='flex flex-col'>
                {showCode ?
                    <div>
                        ...
                        <CodeBlock name={"With icons"} code={defaultButtonsWithIcons} language={"javascript"} />
                    </div>
                    :
                    <section className='flex flex-wrap rounded-lg gap-1 p-4 bg-white border border-neutral-200 w-full dark:bg-[#222222] dark:border-neutral-700'>
                        <DefaultAlertWithIcon />
