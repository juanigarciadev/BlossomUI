...
const SolidJSInstallation = () => {
    const { theme } = useContext(ThemeContext)
    const [copy, setCopy] = useState(false)

    const createVite = 'npx degit solidjs/templates/js my-project\ncd my-project'
    ...
    return (
        <div>
            <h3 className='text-4xl font-bold pb-4 text-neutral-800 dark:text-white'>With SolidJS</h3>
            <ol className='flex flex-col gap-8 pb-8'>
                <li className='grid grid-cols-2 xl:flex xl:flex-col'>
                    <section className='flex gap-2'>
                        <div>
                            ...
                            <p className='dark:text-neutral-300 pb-4'>Start by creating a new SolidJS project if you don't have one set up already. The most common aproach is to use the SolidJS Vite template.</p>
                        </div>
                    </section>
                ...
                <li className='grid grid-cols-2 xl:flex xl:flex-col'>
                    ...
                    <section className='ml-2 xl:ml-8 shadow-md'>
                        <article className='flex justify-between items-center w-full h-8 bg-corporative rounded-t-md'>
                            <div className='relative flex items-center bg-[#bd4c86] h-8 px-4'>
                                <span className='cursor-default text-white'>index.css</span>
                                <div className='absolute bg-black h-[2px] w-full bottom-0 left-0 dark:bg-white'></div>
                            </div>
                            <div className='text-sm pr-4 cursor-pointer'>
                                {copy ? (
...
export default SolidJSInstallation