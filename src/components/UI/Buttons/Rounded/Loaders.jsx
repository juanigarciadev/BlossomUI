export const PrimaryRoundedButtonLoaders = () => {
    return (
        <button className='flex justify-center w-fit h-fit text-sm items-center text-center bg-black text-white gap-2 px-4 py-3 rounded-full cursor-progress font-medium select-none dark:bg-white dark:text-black'><div className='w-4 h-4 rounded-full border-2 border-neutral-200 border-l-neutral-500 dark:border-l-neutral-600 dark:border-neutral-400 animate-spin'></div>Primary</button>
    )
}

export const SecondaryRoundedButtonLoaders = () => {
    return (
...
export const DefaultRoundedButtonLoaders = () => {
    return (
...
export const RedRoundedButtonLoaders = () => {
    return (
...
export const GreenRoundedButtonLoaders = () => {
    return (
...
export const YellowRoundedButtonLoaders = () => {
    return (
...
export const PurpleRoundedButtonLoaders = () => {
    return (
...
export const PinkRoundedButtonLoaders = () => {
    return (
