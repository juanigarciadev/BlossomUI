...
export const TextRating = () => {
    return (
        <div className='inline-flex gap-2'>
            ...
            <section className="text-neutral-6700 text-sm dark:text-neutral-300">
                3.67 out of 5
            </section>
        </div>
    )
...
export const ReviewsNumber = () => {
    return (
        <div className='inline-flex gap-2 items-center'>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 256 256"><path fill="#ffaf39" d="m234.5 114.38l-45.1 39.36l13.51 58.6a16 16 0 0 1-23.84 17.34l-51.11-31l-51 31a16 16 0 0 1-23.84-17.34l13.49-58.54l-45.11-39.42a16 16 0 0 1 9.11-28.06l59.46-5.15l23.21-55.36a15.95 15.95 0 0 1 29.44 0L166 81.17l59.44 5.15a16 16 0 0 1 9.11 28.06Z" /></svg>
            <p className="text-neutral-6700 text-sm dark:text-neutral-300">3.67</p>
            <span className="w-1 h-1 rounded-full bg-black dark:bg-white"></span>
            <a href="#" className="text-neutral-700 text-sm underline hover:no-underline dark:text-neutral-300">127 reviews</a>
        </div>
    )
}

export const RatingReviewComment = () => {
    return (
        <div className='grid gap-4'>
            <section className='flex gap-3'>
                ...
                <div className='flex flex-col -gap-1'>
                    ...
                    <span className='text-sm text-neutral-700 dark:text-neutral-300'>Published 4th June, 2020.</span>
                </div>
            </section>
            <section className="inline-flex gap-2 items-center sm:grid">
                <div className="inline-flex gap-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 256 256"><path fill="#ffaf39" d="m234.5 114.38l-45.1 39.36l13.51 58.6a16 16 0 0 1-23.84 17.34l-51.11-31l-51 31a16 16 0 0 1-23.84-17.34l13.49-58.54l-45.11-39.42a16 16 0 0 1 9.11-28.06l59.46-5.15l23.21-55.36a15.95 15.95 0 0 1 29.44 0L166 81.17l59.44 5.15a16 16 0 0 1 9.11 28.06Z" /></svg>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 256 256"><path fill="#ffaf39" d="m234.5 114.38l-45.1 39.36l13.51 58.6a16 16 0 0 1-23.84 17.34l-51.11-31l-51 31a16 16 0 0 1-23.84-17.34l13.49-58.54l-45.11-39.42a16 16 0 0 1 9.11-28.06l59.46-5.15l23.21-55.36a15.95 15.95 0 0 1 29.44 0L166 81.17l59.44 5.15a16 16 0 0 1 9.11 28.06Z" /></svg>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 256 256"><path fill="#ffaf39" d="m234.5 114.38l-45.1 39.36l13.51 58.6a16 16 0 0 1-23.84 17.34l-51.11-31l-51 31a16 16 0 0 1-23.84-17.34l13.49-58.54l-45.11-39.42a16 16 0 0 1 9.11-28.06l59.46-5.15l23.21-55.36a15.95 15.95 0 0 1 29.44 0L166 81.17l59.44 5.15a16 16 0 0 1 9.11 28.06Z" /></svg>
            ...
            <section className="grid gap-3 text-neutral-700 dark:text-neutral-300">
                <p>Blossom UI is a game-changer in the world of ReactJS component libraries. As a web developer always on the lookout for ways to streamline and enhance my projects, I couldn't be more thrilled with what Blossom UI has to offer.</p>
                <p>From the moment I integrated Blossom UI into my project, it was evident that this library was designed with an exceptional attention to detail. The components are not only visually stunning, thanks to Tailwind CSS, but they are also incredibly versatile and user-friendly. Whether you're working on a personal blog or a complex web application, Blossom UI has the components you need to make your project truly blossom.</p>
