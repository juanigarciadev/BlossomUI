export const DefaultBanner = () => {
  return (
    <div className="w-full">
        <div className="relative inline-flex w-full gap-2 top-0 justify-center items-center z-50 p-6 bg-neutral-100 border-y border-neutral-300 dark:bg-neutral-800 dark:border-neutral-700">
