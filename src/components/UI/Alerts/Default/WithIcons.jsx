...
export const DefaultAlertWithIcon = () => {
    return (
...
export const DefaultSuccessfulAlertWithIcon = () => {
    return (
...
export const DefaultErrorAlertWithIcon = () => {
    return (
...
export const DefaultWarningAlertWithIcon = () => {
    return (
