...
export const DefaultAlertWithList = () => {
    return (
        <div className='w-full h-fit px-4 py-4 bg-blue-100 rounded-lg dark:bg-blue-900'>
            ...
            <ul className='list-disc pl-16 md:pl-5'>
                <li className='text-blue-900 dark:text-blue-300'>First list item of the alert.</li>
                <li className='text-blue-900 dark:text-blue-300'>Second list item of the alert.</li>
                <li className='text-blue-900 dark:text-blue-300'>Third list item of the alert.</li>
            </ul>
        </div>
    )
}

export const DefaultSuccessfulAlertWithList = () => {
    return (
        <div className='w-full h-fit px-4 py-4 bg-green-100 rounded-lg dark:bg-green-900'>
            ...
            <ul className='list-disc pl-16 md:pl-5'>
                <li className='text-green-900 dark:text-green-300'>First list item of the alert.</li>
                <li className='text-green-900 dark:text-green-300'>Second list item of the alert.</li>
                <li className='text-green-900 dark:text-green-300'>Third list item of the alert.</li>
            </ul>
        </div>
    )
}

export const DefaultErrorAlertWithList = () => {
    return (
        <div className='w-full h-fit px-4 py-4 bg-red-100 rounded-lg dark:bg-red-900'>
            ...
            <ul className='list-disc pl-16 md:pl-5'>
                <li className='text-red-900 dark:text-red-300'>First list item of the alert.</li>
                <li className='text-red-900 dark:text-red-300'>Second list item of the alert.</li>
                <li className='text-red-900 dark:text-red-300'>Third list item of the alert.</li>
            </ul>
        </div>
    )
}

export const DefaultWarningAlertWithList = () => {
    return (
        <div className='w-full h-fit px-4 py-4 bg-yellow-100 rounded-lg dark:bg-yellow-600'>
            ...
            <ul className='list-disc pl-16 md:pl-5'>
                <li className='text-yellow-600 dark:text-yellow-200'>First list item of the alert.</li>
                <li className='text-yellow-600 dark:text-yellow-200'>Second list item of the alert.</li>
                <li className='text-yellow-600 dark:text-yellow-200'>Third list item of the alert.</li>
            </ul>
        </div>
    )
}
