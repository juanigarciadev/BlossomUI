...
export const DefaultOutlinedRounded = () => {
  return (
    <span className='flex items-center h-fit w-fit text-xs px-2.5 py-1 font-medium border bg-blue-100 border-blue-900 text-blue-900 rounded-full cursor-default dark:bg-neutral-700 dark:text-blue-400 dark:border-blue-400'>And this is the rounded outlined version</span>
  )
}

export const DarkOutlinedRounded = () => {
  return (
...
export const RedOutlinedRounded = () => {
  return (
...
export const GreenOutlinedRounded = () => {
  return (
...
export const YellowOutlinedRounded = () => {
  return (
...
export const PurpleOutlinedRounded = () => {
  return (
...
export const PinkOutlinedRounded = () => {
  return (
