...
export const DefaultOutlinedRounded = () => {
  return (
    <span className='flex items-center h-fit w-fit text-sm px-4 py-2 font-medium border bg-blue-100 border-blue-900 text-blue-900 rounded-full cursor-default dark:bg-neutral-700 dark:text-blue-400 dark:border-blue-400'>And this is the rounded outlined version</span>
  )
}
