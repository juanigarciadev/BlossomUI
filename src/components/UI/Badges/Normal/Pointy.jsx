export const DefaultPointy = () => {
    return (
        <span className='flex items-center font-medium h-fit w-fit text-xs px-2.5 py-1 bg-blue-100 text-blue-900 cursor-default dark:bg-blue-900 dark:text-blue-300'>This is the filled version of the badge</span>
    )
}
