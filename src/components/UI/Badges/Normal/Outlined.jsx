...
export const DefaultOutlined = () => {
  return (
    <span className='flex items-center h-fit w-fit text-xs px-2.5 py-1 font-medium border bg-blue-100 border-blue-900 text-blue-900 rounded-lg cursor-default dark:bg-neutral-700 dark:text-blue-400 dark:border-blue-400'>And this is the outlined version</span>
  )
}
